...
- If you have implemented extra functionalities not mentioned in the manual,
  you may specify them here.
    - You can clear all drawn points
    - You can offset the origin for the bonus functions
    - You can show the axes for the bonus origin
        - Uses GL_LINES to draw for simplicity
...
- Doesn't use config file; all bonus parameters are inputed through the GUI.
